...
return '<div id="joke'+pJokeId+'" class="row jokeBox">'+
	'<div class="row jokeUpper">'+
		...
		'<div class="jokerNameBox"><a class="jokerName" href="joker.html?id='+pJoker+'">'+pJokerName+'</span></div>'+
	'</div>'+
	'<div class="row jokeTitleBox"><a class="jokeTitle" href="joke.html?id='+pJokeId+'">'+pJokeTitle+'</span></div>'+
