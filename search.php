...
$keywordsNWS = preg_replace('/\s+/', '+', $keywords);

$redirUrl = DOMAIN_URL.'search.php?keywords='.$keywordsNWS;
...
$url = API_URL_PREFIX."search/search/";
$key = genKey($id);
// $keywords = preg_split('/\s+/', $_GET['keywords']);
$keywordsArray = explode("+", $keywordsNWS);
// echo $keywords;
...
$logoutParams='uri=search&&keywords='.$keywordsNWS;
// echo $logoutParams;
